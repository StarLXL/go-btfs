...
`,
    ...
    "ns", "us" (or "µs"), "ms", "s", "m", "h".`).WithDefault("24h"),
		cmds.BoolOption(allowOfflineOptionName, "When offline, save the BTNS record to the the local ds without broadcasting to the network instead of simply failing."),
